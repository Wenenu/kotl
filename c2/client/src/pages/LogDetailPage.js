...
const LogDetailPage = () => {
    ...
    const FILE_TYPE_CONFIG = {
        ...
        'OpenVPN': { icon: '', color: '#ea7e20', description: 'VPN Config' },
        'HeidiSQL': { icon: '', color: '#4ade80', description: 'Database Client' },
        ...
        'TeamViewer': { icon: '', color: '#004680', description: 'Remote Access' },
        'RemoteDesktop': { icon: '', color: '#00a2ed', description: 'RDP Files' },
        'Cyberduck': { icon: '', color: '#ffc107', description: 'FTP Client' },
        '7Zip': { icon: '', color: '#000000', description: 'Archive Settings' },
        'Norton': { icon: '', color: '#ffc40d', description: 'Password Manager' },
        'Origin': { icon: '', color: '#f56c2d', description: 'Gaming Platform' },
        'PrismLauncher': { icon: '', color: '#3b82f6', description: 'Minecraft Launcher' },
        'MultiMC': { icon: '', color: '#22c55e', description: 'Minecraft Launcher' },
        'LunarClient': { icon: '', color: '#1e3a8a', description: 'Minecraft Client' },
        'Feather': { icon: '', color: '#8b5cf6', description: 'Minecraft Client' },
        'TLauncher': { icon: '', color: '#ef4444', description: 'Minecraft Launcher' },
        'Essential': { icon: '', color: '#f59e0b', description: 'Minecraft Mod' },
        'ATLauncher': { icon: '', color: '#0ea5e9', description: 'Minecraft Launcher' },
        '1Password': { icon: '', color: '#0094f5', description: 'Password Manager' },
        'AnyDesk': { icon: '', color: '#ef443b', description: 'Remote Access' },
        'AutoFTPManager': { icon: '', color: '#3b82f6', description: 'FTP Manager' },
        'CloudCredentials': { icon: '', color: '#ff9900', description: 'Cloud Access' },
        ...
        'GoogleCloud': { icon: '', color: '#4285f4', description: 'Cloud Platform' },
        'NordPass': { icon: '', color: '#4687ff', description: 'Password Manager' },
        'NordVPN': { icon: '', color: '#4687ff', description: 'VPN' },
        'ProtonVPN': { icon: '', color: '#6d4aff', description: 'VPN' },
        'RealVNC': { icon: '', color: '#0052cc', description: 'Remote Access' },
        'SmartFTP': { icon: '', color: '#00a2ed', description: 'FTP Client' },
        'TightVNC': { icon: '', color: '#14b8a6', description: 'Remote Access' },
        'TotalCommander': { icon: '', color: '#3b82f6', description: 'File Manager' },
        'UltraVNC': { icon: '', color: '#6366f1', description: 'Remote Access' },
        ...
        'AWS': { icon: '', color: '#ff9900', description: 'AWS Credentials' },
        'SensitiveFile': { icon: '', color: '#ef4444', description: 'Sensitive Data' },
